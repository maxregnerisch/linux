...
elif echo ${VERSION} | grep -e "\.[0-9]*\.[0-9]*\.0$" ; then
...
ALLOWROOT=1 bash mklinux -i -o "./mros/linux" -t linux -c "https://raw.githubusercontent.com/archlinux/svntogit-packages/packages/linux/trunk/config" -y 1
